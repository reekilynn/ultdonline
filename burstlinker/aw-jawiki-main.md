...
> 只有通过制造人偶进行远程操作的Chocolat Puppetter这样的情况才是例外。
...
名为「兴奋」的北斗七星二号星（beta）《天璇》。安置于东京站地下迷宫。目前由紫之王Purple Thorn以锡杖的形式持有。
...
* 积累过去持有者的能力和必杀技，反馈到下一个使用者身上。但这一能力仅在与铠的同步率最高的第六代（Silver Crow）上体现。故事中除了Crow自身的《飞行（Aviation）》《光线剑（Laser Sword）》《光线枪（Laser Lance））》之外，还使用了以下能力：
    ...
    * 模拟瞬间移动的必杀技<b>《Flash Blink》</b>。来自初代（Chrome Falcon）。
...
White Cosmos通过能力将Red Rider的复制记忆数据寄生在某个Burst Linker上，利用Rider的能力<b>《枪械创造》</b>量产了ISS Kit。
...
互相之间处于链接状态，当与其中一方交战时，剩余的三方会进行支援回复。和其他Enemy不同，拥有超出AI级别的，毫不逊色于人类的智慧和意志。对踏入《帝城》四方城门领域的对手会进行毫不留情的攻击，并且对梅塔特隆等同阶Enemy保有蔑视的态度。和通常的Enemy在行动上也存在很大差异，会在交战过程中突然改变战斗模式。

本质是封印了The Fluctuating Light的《领导者A》创造的，拥有Light-Cube的最上级Being，并位于和系统隔离的地址中。

##### 朱雀

守护帝城南门（现实世界中的樱田门）的四神。有着比红玉更加血红的眼瞳的，身缠烈焰的巨鸟。具备操控火焰的强劲能力，可以从口中吐出火焰吐息，或是在拍打双翼时产生超高热量的气浪。

##### 青龙

守护帝城东门（现实世界中的坂下门）的四神。有着蓝色的巨体和蓝宝石色的眼镜。持有多种特殊攻击能力、包含口中喷射超高压水流的<b>《Water Breath》</b>、从上空打下轰雷造成被雷击者短时间麻痹的<b>《Thunder Blast》</b>、名称不明的冻结攻击、尾部敲打地面产生的振动波（一旦碰到则无法行动）、以及放出高粘度的黑球捕获对战虚拟体并夺取BP、当BP耗尽时开始扣减等级的<b>《Level Drain》</b>[25]。

> 降级时获得的升级奖励也会一并丧失，但若再度升级，则可以重新选择奖励。此外，若没有降级而只是扣减点数，那么会被系统识别为异常状态，因此可以通过Lime Bell的《Citron Call》恢复到点数被扣减之前的状况。

##### 玄武

守护帝城北门（现实世界中的乾门）的四神。虽然动作缓慢，但能够大范围操控重力，在四神中拥有最强的防御力，即使是Graphite Edge的双剑《Lux》和《Umbra》也无法斩出伤口。

##### 白虎

守护帝城西门（现实世界中的半藏门）的四神。擅长使用锐利的爪牙进行高速近距离战斗。

### 心意系统（Incarnate System）
