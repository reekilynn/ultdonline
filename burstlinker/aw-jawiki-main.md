...
> 1. 侵入行为（Hacking）的意义仅限于「需要高技术水平的计算机利用方式」，本身并没有善恶之分。恶意行为一般称为Cracking。
...
> 2. 选项一般为3到4个，可选择既有能力的强化，或是获取新的必杀技/强化外装。由于新能力一般只伴有简单的说明文字，并不能在取得奖励前尝试，也不能在取得后更换，因此一般没有必要再升级后立刻获得奖励。此外，一旦不断获取单一类型的奖励，即使升到最高等级也无法获得额外的特典奖励。

> 3. 例如在海之日实装《大海》Stage，在下水道之日（9月10日）实装《下水道》Stage，在Hermes Cord距离日本最近的时间（2047年6月5日下午5时35分）开放《Hermes Cord纵贯赛》的登录，在向日葵之日（2047年7月14日）开放《宇宙》Stage。
...
> 4. 但这些内容只是White Cosmos的一面之词，关于其可信度有相当大的疑问。
